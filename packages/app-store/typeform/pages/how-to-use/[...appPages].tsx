    ...
    <div className="flex h-screen bg-gray-200">
      <div className="m-auto rounded bg-white p-10">
        <div className="flex flex-row">
          ...
          <div className="ml-5">
            <div className="text-md text-gray-800">How to route a Typeform with PulseAppt.com Routing</div>
            <ol className="mt-5 mb-5 ml-5 mr-5 list-decimal">
              ...
              <li>Create a Typeform that you want to route through PulseAppt.com form&apos;s routing</li>
              <li>
              ...
              <li>
                You&apos;re set! Now, when the Typeform gets responses they would be routed through
                PulseAppt.com routing
              </li>
            </ol>
